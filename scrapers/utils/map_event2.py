def return_dual_divisional_allstar_events(event):
    # Dual, Divisional, and All-Star Events
    dual_divisional_allstar_events = {
        "Boys Free 25M 8&U": 1,
    ...
    return dual_divisional_allstar_events[event]

# Division Relays and All-Star Relay Carnival
def return_division_allstar_relays (event):
    
    map_event= {
    "Girls Free 200M Relay Mixed Age": 1,
    "Boys Free 200M Relay Mixed Age": 2,
    "Girls Medley 100M Relay 8&U": 3,
    "Boys Medley 100M Relay 8&U": 4,
    "Girls Medley 100M Relay 9-10": 5,
    "Boys Medley 100M Relay 9-10": 6,
    "Girls Medley 100M Relay 11-12": 7,
    "Boys Medley 100M Relay 11-12": 8,
    "Girls Medley 200M Relay 13-14": 9,
    "Boys Medley 200M Relay 13-14": 10,
    "Girls Medley 200M Relay 15-18": 11,
    "Boys Medley 200M Relay 15-18": 12,
    "Girls Free 100M Relay 8&U": 13,
    "Boys Free 100M Relay 8&U": 14,
    ...
    try:
        ...
        print(f"Error with event: {event} / {e}")
