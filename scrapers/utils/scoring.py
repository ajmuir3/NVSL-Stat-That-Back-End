def dual_meet_points(place,individual):
    if individual == True:
        dual_meet_scoring = {
            "1": 5,
            "2": 3,
...
def divisional_relays_points(place):
    ...
    # Use .get() to avoid KeyError and return 0 if place is invalid
    return divisional_relays_scoring.get(str(place).strip(), 0)
