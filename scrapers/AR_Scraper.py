...
TEAM_SCORES_FILE = "AllStarRelay_TeamScores.csv"
EVENT_RESULTS_FILE = "AllStarRelay_EventResults.csv"

def scrape_all_star_relay_page(url):
    """
    Scrapes an All Star Relay page and extracts relevant information:
    - Team scores
    - Event results
    """
...
def main():
    # URL of the All Star Relay page (replace with actual URL)
    all_star_relay_url = "https://mynvsl.com/results/26585?back=dv"

    # Scrape the page
    team_scores, event_results = scrape_all_star_relay_page(all_star_relay_url)
