...
def meet_data(meet_info,home_team,away_team,div):
    ...
    scores = split_swim_meet_result(meet_info[3]) 

    #Home vs Away Team
    home_abbr = return_abbr(home_team)
    away_abbr = return_abbr(away_team)
    home_team_points = scores[home_team]
    away_team_points = scores[away_team]
    ...
    return meet_id,home_team_id,away_team_away,home_team_points,away_team_points,title,year,date,location,div,course
